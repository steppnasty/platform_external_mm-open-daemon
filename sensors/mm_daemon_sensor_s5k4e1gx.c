...
static int s5k4e1gx_init_regs(mm_sensor_cfg_t *cfg)
{
    return cfg->ops->i2c_write_array(cfg->mm_snsr, s5k4e1gx_init_settings,
            ARRAY_SIZE(s5k4e1gx_init_settings), MSM_CAMERA_I2C_BYTE_DATA);
}
